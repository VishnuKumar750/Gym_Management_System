...
import { getMemberAnalytics } from "@/api/user/user.api";
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col gap-2">
        <h1 className="text-xl">Member Analytics</h1>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <MiniStat
              label="This Month"
              value={`₹${quickStats.thisMonthSpent}`}
            />
            <MiniStat
              label="Last Month"
              value={`₹${quickStats.lastMonthSpent}`}
            />
            <MiniStat
              label="Member Since"
