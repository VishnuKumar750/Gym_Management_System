...
const fetchPackages = async () => {
  ...
  return data.data.packages; // assuming array [{ _id, name }]
};
    ...
    <Sheet>
      <SheetTrigger asChild>
        <Button variant={"outline"}>
          <CirclePlus className="w-4 h-4" /> Add Member
        </Button>
      </SheetTrigger>
      <SheetContent>
        <SheetHeader>
        ...
        >
          <FieldSet>
            <FieldGroup>
              ...
              {/* Assigned Package */}
              <Field>
                <FieldLabel htmlFor="assignedPackage">
                  Assigned Package
                </FieldLabel>
                <select
                  id="assignedPackage"
                ...
                {form.formState.errors.assignedPackage && (
                  <FieldDescription className="text-red-500">
                    {form.formState.errors.assignedPackage.message}
                  </FieldDescription>
                )}
              </Field>
            </FieldGroup>
